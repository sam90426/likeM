...
<div id="datagrid1" class="mini-datagrid" style="width: 100%;" allowresize="true"
     url="/sys/sysdiccontentlistp" multiselect="true" pagesize="25"
     onrowdblclick="edit()">
    <div property="columns">
        ...
        <div field="string1" width="100" headeralign="center" allowsort="true">
            字典简介
        </div>
...
<script src="/assets/pagejs/sys/sysdiccontentlist.js?v=1.0.0" type="text/javascript"></script>
</body>
</html>
