...
//添加
function add() {
    ShowCommonDialog("/info/ggdiccontentedit?path=" + path, "广告位 - 新增", 680, 520);
}
//编辑
function edit() {
    var row = grid.getSelected();
    if (row) {
        ShowCommonDialog("/info/ggdiccontentedit?id=" + row.id, "广告位 - 编辑", 680, 520);
    } else {
