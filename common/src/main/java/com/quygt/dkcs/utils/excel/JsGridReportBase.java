package com.quygt.dkcs.utils.excel;
...
public class JsGridReportBase {
    ...
    /**
     * hj
     * Excel报表导出通用方法（含多个sheet导出），设置是否合并单元格
     *
     * @throws Exception
     */
    public void exportExcel(List<Object> list, String title, String[] hearders, String[] fields, String operatorName, boolean grouped) throws Exception {
    ...
    private HashMap<String, HSSFCellStyle> initStyles(HSSFWorkbook wb) {
        ...
        try {
            ...
            //InputStream is=this.getClass().getResourceAsStream("module.xls");
